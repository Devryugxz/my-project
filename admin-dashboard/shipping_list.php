...
try {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td><a href='shipping.php?act=edit&ID=$row[ship_id]' class='btn btn-warning btn-sm'><span class='fa fa-edit'></span></a>         
    </td> ";
        echo "<td><a href='shipping_del_db.php?ID=$row[ship_id]' onclick=\"return confirm('ยันยันการลบ')\" class='btn btn-danger btn-sm'><span class='fas fa-trash-alt'></span></a></td> ";
        echo "</tr>";
    }
    echo "</table>";
