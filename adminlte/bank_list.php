...
try {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<td class='center'><a href='bank.php?act=edit&ID=$row[b_id]' class='btn btn-warning btn-sm'><span class='fa fa-edit'></span></a></td>";
        echo "<td class='center'><a href='bank_del_db.php?ID=$row[b_id]' onclick=\"return confirm('ยันยันการลบ')\" class='btn btn-danger btn-sm'><span class='fas fa-trash-alt'></span></a></td>";
        echo "</tr>";
    }
